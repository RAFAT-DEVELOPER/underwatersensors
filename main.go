...
import (
	...
	"github.com/RAFAT-DEVELOPER/underwatersensors/api/routes"
	_ "github.com/RAFAT-DEVELOPER/underwatersensors/docs"
...
// @title           UnderWaterSensors API (Go language test task)
// @version         1.0
// @description     UnderWaterSensors is a backend API implementation for a set of underwater sensors developed as a test task.
// @termsOfService  https://github.com/RAFAT-DEVELOPER/underwatersensors

// @contact.name   Rafat Khan
// @contact.email  rafatkhan88@gmail.com
...
func main() {
	...
	router.GET("/healthchecker", func(ctx *gin.Context) {
		message := "UnderWaterSensors Apis are up and running"
